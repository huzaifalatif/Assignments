...
let targetFruit1 = 'banana';
let targetFruit2 = 'grape';

// Test whether an item is in an array
let isTargetFruit1InArray = fruitsArray.indexOf(targetFruit1) !== -1;
console.log(`Is '${targetFruit1}' in the fruitsArray? I predict ${isTargetFruit1InArray}.`);

// Test whether an item is not in an array
let isTargetFruit2NotInArray = fruitsArray.indexOf(targetFruit2) === -1;
console.log(`Is '${targetFruit2}' not in the fruitsArray? I predict ${isTargetFruit2NotInArray}.`);
